...
export const QrCodeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m6 11h2v2h-2v-2zm-8 3h-2v1.5c0 .276.224.5.5.5h1.5v-2zm-2-5h2v2h-2v-2zm0-4h2v2h-2v-2zm3-3h2v2h-2v-2zm5 11h2v2h-2v-2zm0-4h2v2h-2v-2zm4 0h2v2h-2v-2zm0-4h2v2h-2v-2zm-5-3h2v2h-2v-2zm-8 0h2v2h-2v-2zm-2 0h2v2h-2v-2zM4 4h6v6H4V4zm10 0h6v6h-6V4zM4 14h6v6H4v-6z" />
...
export const ViewfinderIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h4M3 3v4M21 3h-4M21 3v4M3 21h4M3 21v-4M21 21h-4M21 21v-4M12 8v8" />
    </svg>
);
